<template>
    <div style="height: 500px;">
        ...
        <el-button :disabled="!local_selected_instance" type="primary" style="margin-left: 1em;"
                   @click="set_applets_config">Select
        </el-button>


        <div style="margin: 2em 0;" v-if="local_selected_instance">
            <el-select v-model="local_selected_instance" filterable placeholder="Select instance config"
                       no-match-text="No instances found">
                <el-option
                        v-for="item in instances"
                        :key="item.id"
        ...
        <div style="margin: 2em 0;">
            ...
            <el-form :inline="true">
                <el-form-item>
                    <el-input type="text" placeholder="Instance name" v-model="new_instance_name" slot-scope="name">
...
<script lang='ts'>
    ...
    import {create_new_instance, get_instances} from "../lib/instance";
    ...
    export default Vue.extend({
        ...
        methods: {
            async create_new_instance() {
                const result = await create_new_instance({name: this.new_instance_name})
            },
            async get_list_of_instances() {

                this.instances = await get_instances(this.user.id)
            },
