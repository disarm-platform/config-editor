...
<script lang="ts">
  ...
  export default Vue.extend({
    components: {Login, Instances, Config, Geodata, Publish,}, data() {
      return {active_tab: 'instances', config_valid: false, geodata_layers: [], location_selection: null,};
    }, watch: {
      ...
      change(updated_config, pathname, included) {/* save config to store here*/
        ...
        const config_copy = cloneDeep(this.config);
      ...
      set_location_selection(location_selection: any) {
